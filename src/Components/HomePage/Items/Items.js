...
const Items = () => {
    return (
        <div>
            <div className="bg-green-800 bg-left-top bg-auto bg-repeat-x h-[400px]" style={{ backgroundImage: "url(https://multichannelmerchant.com/wp-content/uploads/2017/09/inventory-management-clipboard-warehouse-guy-feature.jpg)" }}>
            </div>
